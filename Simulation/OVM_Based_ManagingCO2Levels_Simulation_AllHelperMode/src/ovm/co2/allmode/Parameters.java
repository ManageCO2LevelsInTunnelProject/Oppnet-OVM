...
//seed create help object and oppnet tasks
public static double task1RuntimeMin = 29;
public static double task1RuntimeMax = 43; 

//seed send help object (rading time + communucation)
public static double task2RuntimeSeedZigBeeMin = 35.88;
public static double task2RuntimeSeedZigBeeMax = 49.88; 
//smartphone read and forward help object
public static double approxTask2RuntimeRegHlprWiFi =  0.176; 
//car read and forward help object
public static double approxTask2RuntimeRegHlprBT = 0.532;
//billboard2 read and forward help object
public static double task2RuntimeLiteZigBeeMin = 35.88;
public static double task2RuntimeLiteZigBeeMax = 49.88;

//seed send oppnet tasks(rading time + communucation)
public static double task3RuntimeSeedZigBeeMin = 41.96;
public static double task3RuntimeSeedZigBeeMax = 55.96; 
//smartphone forward and read oppnet task
public static double approxTask3RuntimeRegHlprWiFi = 0.3008;
//car forward and read oppnet task
public static double approxTask3RuntimeRegHlprBT = 0.948;
 //billboard2 forward and read oppnet task
public static double task3RuntimeLiteZigBeeMin = 41.96;
public static double task3RuntimeLiteZigBeeMax = 55.96;  

//time for reqular helpers (car- smartphone) to display text help msg
public static double task4RuntimeMin = 5000;
public static double task4RuntimeMax = 11000; 

//time for lite helpers (billboard- billboard2) to display text help msg
public static double task5RuntimeMin = 3000 ;
public static double task5RuntimeMax = 8000; 

// time for fan to circulate air
public static double task6RuntimeMin = 29 ;
public static double task6RuntimeMax = 43; 
