...
public class Create_Ent extends Sim_entity{
	...
	public Sim_uniform_obj task2RuntimeSeedZigBee_Generator;
	...
	public Sim_uniform_obj task5Runtime_Generator;
        	public Sim_uniform_obj task6Runtime_Generator;
	...
	public Create_Ent(String arg0) {
		...
		add_generator(task2RuntimeSeedZigBee_Generator);
		...
		add_generator(task3RuntimeSeedZigBee_Generator);
	...
	task6Runtime_Generator = new Sim_uniform_obj("task6Runtime", p.task6RuntimeMin, p.task6RuntimeMax);
		add_generator(task6Runtime_Generator);
		...
		while(count >0){
			...
			case 1: 
					...
					h.Comm_Channels.add("BT");
                                        ...
                                        h.Comm_Channels.add("Wi-Fi");
                                        h.Comm_Channels.add("Celulare");
